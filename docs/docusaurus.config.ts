...
const config: Config = {
  ...
  projectName: 'vibeauracle', // Usually your repo name.
  trailingSlash: false,
          ...
          items: [
            {
              ...
              href: 'https://stackoverflow.com/questions/tagged/vibeauracle',
            },
            {
              label: 'Discord',
              href: 'https://discordapp.com/invite/vibeauracle',
            },
            {
              label: 'X',
              href: 'https://x.com/vibeauracle',
            },
          ],
        },
        {
